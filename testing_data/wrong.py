...
for round in range(rounds):
    ...
    """
    This is a deliberate mistake, it's correct to comment `print("Invalid")`, 
    remove `print(this_is_an_undefined_variables)` and uncomment `print(isValidSudoku(board))`
    """
    print("Invalid")
    print(this_is_an_undefined_variables)
